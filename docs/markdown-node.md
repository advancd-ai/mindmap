...
- [x] **줄바꿈**: 단일 줄바꿈 또는 `  ` (2 spaces)
       ...
       - [x] **마크다운 툴바**: 자주 사용하는 마크다운 문법 버튼 (완료)
       - [x] **텍스트 정렬 도구**: 왼쪽, 가운데, 오른쪽 정렬 지원
       - [x] **키보드 단축키 안내**: 편집창 하단에 단축키 도움말 표시
...
- **현재 구현된 키보드 단축키**:
  - `Enter`: 새 줄 추가
  - `Alt/Option + Enter`: 저장 후 종료 (기본 단축키)
  - `Ctrl/Cmd + Enter`: 저장 (하위 호환성 유지)
  - `Escape`: 취소
  - `Tab`: 2칸 들여쓰기 (마크다운 컨벤션)
- **추가 예정 키보드 단축키** (Phase 3):
...
- [x] **`MarkdownToolbar`**: 마크다운 문법 삽입을 위한 툴바 ✅
  - 위치: NodeEditor 상단
  - 기능: 마크다운 문법 버튼, 선택 텍스트 감지, 텍스트 정렬
  - 이벤트 처리: blur 방지로 편집 모드 유지
- [ ] **`MarkdownPreview`**: 편집 중 프리뷰 컴포넌트 (Split view용) - Phase 3
- [ ] **`MarkdownEditor`**: 고급 마크다운 에디터 (선택사항, 향후 확장) - Phase 3
...
### Phase 2.5: 마크다운 에디터 도구 ✅ (완료)
- [x] **마크다운 툴바 구현**
  - [x] 툴바 UI 컴포넌트 (`MarkdownToolbar.tsx`)
  - [x] 툴바 위치: NodeEditor 상단
  - [x] 툴바 버튼:
    - [x] **Bold** (`**text**`)
    - [x] *Italic* (`*text*`)
...
- [x] **선택 텍스트 감지**: 버튼 클릭 시 선택된 텍스트에 문법 적용
- [x] **커서 위치 기반 삽입**: 선택 없을 때 커서 위치에 문법 삽입
- [x] **이벤트 처리 개선**: 버튼 클릭 시 편집 모드 유지 (blur 방지)
- [x] **기본 정렬 설정**: 왼쪽 정렬이 기본값
- [x] **도움말 텍스트**: 편집창 하단에 키보드 단축키 안내 표시
...
- `Alt/Option + Enter`로 저장 후 종료
- `Escape`로 취소
- 편집창 하단에 키보드 단축키 안내 표시
- 마크다운 툴바를 사용하여 문법 삽입 가능
...
#### 현재 사용 가능한 기능 (Phase 2.5 완료)
- **마크다운 툴바**: 버튼 클릭으로 문법 삽입 ✅
- **텍스트 정렬**: 왼쪽, 가운데, 오른쪽 정렬 지원 ✅
- **도움말 표시**: 편집창 하단에 키보드 단축키 안내 ✅

#### 향후 추가 예정 (Phase 3)
- **고급 키보드 단축키**: `Ctrl+B` (Bold), `Ctrl+K` (Link) 등
...
## 📊 구현 현황
       ...
       - **Phase 1**: 기본 마크다운 렌더링 (100%)
         ...
         - Node 컴포넌트에 통합
         - 기본 마크다운 문법 지원 (Bold, Italic, Links, Lists, Headings, Code, Blockquote, Horizontal Rule)
       - **Phase 2**: 마크다운 에디터 기본 기능 (100%)
         - Multi-line 지원 (textarea)
         - 자동 높이 조절
         - 기본 키보드 단축키 (Enter, Alt+Enter, Esc, Tab)
       - **Phase 2.5**: 마크다운 툴바 및 에디터 도구 (100%)
         - MarkdownToolbar 컴포넌트 구현
         - 모든 마크다운 문법 버튼 (Bold, Italic, Strikethrough, Code, Link, Heading, List, Blockquote, Code Block, Horizontal Rule)
...
---
       ...
       **상태**: Phase 1, Phase 2, Phase 2.5 완료 / Phase 3 예정
